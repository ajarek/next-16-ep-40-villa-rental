...
function StarDisplay({ rating, size = "sm" }: { rating: number; size?: "sm" | "xs" }) {
  ...
  return (
    <div className="flex items-center gap-0.5">
      ...
      <span className={`ml-1 font-bold text-foreground ${size === "sm" ? "text-xs" : "text-[10px]"}`}>
        {rating}
      </span>
    </div>
  )
            ...
            {filtered.length === 0 ? (
              ...
              >
                ...
                <p className="text-[11px] text-muted dark:text-muted-foreground/70 text-center max-w-[70%]">
                  Nie znaleźliśmy opinii spełniających wybrane kryteria. Spróbuj zmienić filtry.
                </p>
              </motion.div>
            ) : (
              <motion.div
                      ...
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="flex items-center gap-2 mt-0.5">
                            ...
                            <span className="text-[9px] text-muted dark:text-muted-foreground/40">·</span>
            ...
            <div className="relative z-10 flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[10px] text-muted dark:text-muted-foreground/70 mt-1 leading-relaxed">
                  ...
                  Kołobrzegu. Czekają na Ciebie luksusowe wnętrza i niezapomniane
                  widoki!
                </p>
                <button
