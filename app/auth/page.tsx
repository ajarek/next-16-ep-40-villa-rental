...
function AuthContent() {
  ...
  const handleGoogleLogin = async () => {
    ...
    if (!process.env.NEXT_PUBLIC_FIREBASE_API_KEY) {
      ...
      setSubmitting(false)
      setError(
        "Firebase nie jest skonfigurowany. Uzupełnij zmienne w .env.local",
      )
      return
    }
            ...
            <AnimatePresence>
              {mode === AUTH_MODES.REGISTER && (
                ...
                >
                  <label
                    htmlFor='name'
                    className='block text-[11px] font-semibold text-foreground/70 mb-1.5 ml-1'
                  >
                    Imię i nazwisko
                  </label>
            ...
            <div>
              ...
              <div className='relative'>
                ...
                <input
                  ...
                  placeholder={
                    mode === AUTH_MODES.LOGIN ? "••••••••" : "Minimum 6 znaków"
                  }
                  autoComplete={
                    mode === AUTH_MODES.LOGIN
                      ? "current-password"
                ...
                {!resetSent ? (
                  <>
                    ...
                    <p className='text-[11px] text-muted dark:text-muted-foreground/70 mb-4 leading-relaxed'>
                      Podaj adres email powiązany z kontem, a wyślemy Ci link do
                      resetowania hasła.
                    </p>
                    <form
                  ...
                  <div className='flex flex-col items-center py-4'>
                    ...
                    <p className='text-[11px] text-muted dark:text-muted-foreground/70 text-center leading-relaxed'>
                      Sprawdź swoją skrzynkę odbiorczą. Link resetujący został
                      wysłany na{" "}
