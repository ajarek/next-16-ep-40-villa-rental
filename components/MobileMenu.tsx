...
import { X, Home, Search, Calendar, Heart, User, Settings, HelpCircle } from "lucide-react";
...
export default function MobileMenu({ isOpen, onClose }: MobileMenuProps) {
  ...
  const menuItems = [
    { name: "Strona główna", icon: Home, active: true },
    { name: "Szukaj", icon: Search },
    { name: "Moje rezerwacje", icon: Calendar },
    { name: "Ulubione", icon: Heart },
    { name: "Profil", icon: User },
    { name: "Ustawienia", icon: Settings },
    { name: "Pomoc i kontakt", icon: HelpCircle },
  ];
